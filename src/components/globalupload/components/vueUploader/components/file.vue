  ...
  <div class="uploader-file" :status="status" >
    <slot
      ...
      <div class="uploader-file-info">
        ...
        <!-- <div class="uploader-file-size">{{formatedSize + "+" + progressStyle.progress}}</div> -->
...
<script>
  ...
  export default {
    ...
    props: {
      ...
      needActionCheck: Boolean,  // 自定义 是否宣布暂停 重置 _actionCheck
      togglePausedAllStatus: Function
     },
    data () {
      return {
        response: null,
    ...
    computed: {
      fileCategory () {
        ...
        const typeMap = categoryMap || {
          ...
          document: ['doc', 'txt', 'docx', 'pages', 'epub', 'zip', 'pdf', 'numbers', 'csv', 'xls', 'xlsx', 'keynote', 'ppt', 'pptx']
        }
    ...
    watch: {
      ...
      needActionCheck (newvalue, oldvalue) {
          if (newvalue) {
            this._actionCheck()
            this.togglePausedAllStatus(false)
          }
      },
    },
    methods: {
